...
function draw() {
    ...
    if(gameState === "instructions"){
      ...
      strokeWeight(3);
      textSize(70);
      text("Welcome to Plinko!",100,75);
      textSize(30);
      noStroke();
      fill(255);
      text("To play Plinko: (click on the screen once right now) ",20,150);
      text("1. Please wait a few seconds for the score to load.",30,200);
      text("2. Click anywhere on the canvas with your mouse. A",30,250);
      ...
      text("3. After the first particle has landed and vanished,",30,600)
      text("repeat step #2 until you have used 5 particles.",60,650)
      text("4. 6th time you click on the screen, further instructions",30,700)
